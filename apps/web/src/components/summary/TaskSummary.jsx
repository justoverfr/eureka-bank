...
function TaskSummary() {
  return (
    <div className="hidden flex-1 xl:block">
      <div className="dark:bg-darkblack-600 h-full w-full rounded-lg bg-white px-5 py-6">
        <div className="mb-8 flex items-center justify-between">
          <h2 className="text-bgray-900 text-base font-bold xl:text-2xl dark:text-white">
            Task Summary
          </h2>
          <span>
            <svg
          ...
          >
            ...
            >
              <circle
                ...
                cy="20"
                r="19.5"
                className="dark:stroke-bgray-900 stroke-white"
              />
              <path
                opacity="0.4"
                ...
                className="dark:fill-bgray-900 fill-white"
              />
              <path
                opacity="0.4"
        ...
        <div>
          ...
          <div className="flex items-end space-x-4">
            ...
            <span className="text-success-300 text-xs font-medium">+2,5%</span>
          </div>
        </div>
      </div>
    </div>
