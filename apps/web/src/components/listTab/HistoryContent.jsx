    ...
    <tr className="border-bgray-300 dark:border-darkblack-400 border-b">
      ...
      <td className="px-6 py-5 xl:w-[165px] xl:px-0">
        <div className="flex w-full items-center">
          <span
            className={`bg-success-50 block rounded-md px-4 py-1.5 text-sm font-semibold leading-[22px] ${
      ...
      <td className="px-6 py-5 xl:w-[165px] xl:px-0">
        <div className="flex w-full items-center">
          <span className="text-warning-300 dark:bg-darkblack-500 block rounded-md bg-[#FDF9E9] px-4 py-1.5 text-sm font-semibold leading-[22px]">
            {status}
          </span>
        </div>
      </td>
