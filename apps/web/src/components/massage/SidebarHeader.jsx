  ...
  return (
    <header>
      ...
      <div className="relative">
        ...
        <input
          type="text"
          className=" bg-bgray-100 dark:bg-darkblack-500 focus:border-success-300 w-full rounded-lg border-0 py-3.5 pl-12 focus:border focus:ring-0 dark:text-white dark:placeholder:text-white"
