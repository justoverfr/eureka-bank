...
function Profile({ isOpen, close }) {
  return (
    <div
      id="profile-settings"
      className={`dark:bg-darkblack-600 border-bgray-300 dark:border-darkblack-400 absolute right-0 top-0 col-span-3 h-full border bg-white px-12 py-8 ${
        isOpen ? '' : 'hidden'
      }`}
    >
      <header className="border-bgray-300 dark:border-darkblack-400 border-b pb-8">
        ...
        <div className="mt-6 flex flex-col items-center">
          ...
          <div className="bg-bgray-50 dark:bg-darkblack-500 mt-4 flex items-center space-x-2 rounded-xl p-3">
            <span className="bg-success-300 block h-2 w-2 rounded-full"></span>
      ...
      <div className="py-6">
        <h4 className="text-base font-bold dark:text-white">Shared Files</h4>
        <ul className="space-y-3 pt-4">
          <li className="flex items-center justify-between">
            <div className="flex space-x-3">
              <div className="bg-bgray-50 dark:bg-darkblack-500 flex h-10 w-10 items-center justify-center rounded-lg">
                <svg
                  width="16"
                  height="20"
                  viewBox="0 0 16 20"
      ...
      <div className="pb-6">
        <h4 className="text-base font-bold dark:text-white">Shared Links</h4>
        <ul className="space-y-3 pt-4">
          <li className="flex items-center justify-between">
            <div className="flex space-x-3">
              <div className="bg-bgray-50 dark:bg-darkblack-500 flex h-10 w-10 items-center justify-center rounded-lg">
      ...
      {/* Progressbar  */}
      <div className="bg-bgray-100 dark:bg-darkblack-500 mt-4 rounded-lg p-6">
