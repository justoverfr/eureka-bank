...
function SidebarV2() {
  return (
    <aside className="relative hidden w-[96px] bg-white sm:block dark:bg-black">
      <div className="sidebar-wrapper-collapse relative top-0 z-30 w-full">
        <div className="sidebar-header dark:border-darkblack-500 dark:bg-darkblack-600 sticky top-0 z-20 flex h-[108px] w-full items-center justify-center border-b border-r border-b-[#F7F7F7] border-r-[#F7F7F7] bg-white">
          <Link href="/">
            <Image
              priority={true}
              height={logo.height}
        ...
        <div className="sidebar-body w-full pt-[14px]">
          <div className="flex flex-col items-center">
              ...
              <div className="item-wrapper mb-5">
                <ul className="mt-2.5 flex flex-col items-center justify-center">
                  <li className="item px-[43px] py-[11px]">
                    ...
                    <ul className="sub-menu border-success-100 min-w-[200px] rounded-lg border-l bg-white px-5 py-2 shadow-lg">
                      <li>
                        <Link
                          href="/home-2"
                          className="text-md text-bgray-600 hover:text-bgray-800 inline-block py-1.5 font-medium"
                        >
                          Dashboard Two
                        </Link>
                      </li>
            ...
            <div className="upgrade-wrapper">
              <div className="bg-success-300 flex h-10 w-10 items-center justify-center rounded-full border border-white">
                <span>
                  <svg
                    width="24"
                    height="24"
