...
function Sidebar({ handleActive }) {
  ...
  return (
    <aside className="sidebar-wrapper dark:bg-darkblack-600 fixed top-0 z-30 block h-full w-[308px] bg-white sm:hidden xl:block">
      <div className="sidebar-header dark:border-darkblack-400 relative z-30 flex h-[108px] w-full items-center border-b border-r border-b-[#F7F7F7] border-r-[#F7F7F7] pl-[50px]">
        <Link href="/">
          <Image
            priority={true}
            height={logo.height}
      ...
      <div className="sidebar-body overflow-style-none relative z-30 h-screen w-full overflow-y-scroll pb-[200px] pl-[48px] pt-[14px]">
        <div className="nav-wrapper mb-[36px] pr-[50px]">
          <div className="item-wrapper mb-5">
            <h4 className="border-bgray-200 text-bgray-700 dark:border-darkblack-400 dark:text-bgray-50 border-b text-sm font-medium leading-7">
              Menu
            </h4>
            <ul className="mt-2.5">
              <li
                className="item text-bgray-900 py-[11px] dark:text-white"
              ...
              >
                ...
                <ul
                  className={`sub-menu border-success-100 ml-2.5 mt-[22px] border-l pl-5 ${
                ...
                >
                  <li>
                    <Link
                      href="/"
                      className="text-md text-bgray-600 hover:text-bgray-800 dark:text-bgray-50 hover:dark:text-success-300 inline-block py-1.5 font-medium transition-all"
                    >
                      Dashboard Default
                    </Link>
                  </li>
              ...
              <li className="item text-bgray-900 py-[11px] dark:text-white">
        ...
        <div className="upgrade-wrapper mb-[26px] h-[172px] w-full pr-[24px]">
          ...
          >
            <div
              ...
              className="bg-success-300 absolute flex h-10 w-10 items-center justify-center rounded-full border border-white"
            >
              <span>
                <svg
                  width="24"
