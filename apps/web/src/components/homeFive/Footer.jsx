...
function Footer() {
  return (
    <section className="bg-basicInterface relative flex w-full flex-col items-center justify-center px-[5%] xl:mt-0 2xl:px-0">
      <Image
        src={bg.src}
        height={bg.height}
        width={bg.width}
      ...
      />
      <div className="z-10 flex w-full max-w-[1320px] flex-col gap-5 py-[60px] xl:flex-row xl:justify-center 2xl:gap-[123px] 2xl:py-[120px]">
        {/* <!-- fast col  --> */}
        <div className="w-full max-w-[270px]">
          ...
          <div className="flex gap-[10px] pt-5">
            <div className="group relative flex h-10 w-10 items-center justify-center rounded-full transition-all">
              <div className="group-hover:bg-primary absolute z-0 h-full w-full rounded-full bg-white opacity-10 transition-all group-hover:opacity-100"></div>
              <div className="z-10">
                {/* <!-- facebook svg  --> */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <g clipPath="url(#clip0_570_11628)">
                    <path
                      ...
                      className="fill-[#747681] transition-all group-hover:fill-white"
                    />
                  </g>
                  <defs>
        ...
        <div className="flex flex-col gap-6 xl:flex-row xl:gap-[74px]">
          {/* <!-- links  --> */}
          <div className="mt-7 flex xl:mt-0 xl:justify-center">
            <div className="bg-basicWhite hidden h-[198px] w-[1px] opacity-20 xl:block"></div>

            <div className="flex flex-col gap-4 pr-[71px] xl:gap-7 xl:pl-[22px]">
              <span className="leading-150 text-xl font-semibold text-white xl:text-2xl">
                Links
              </span>
              <div className="flex flex-col gap-[14px]">
                <Link
                  href="#"
                  className="text-basicInterface2 leading-180 text-base font-medium xl:text-lg"
                >
                  Home
                </Link>
                <Link
          ...
          <div className="flex xl:justify-center">
            <div className="flex flex-col gap-4 pr-12 xl:gap-7">
              <span className="leading-150 text-xl font-semibold text-white xl:text-2xl">
                Services
              </span>
              <div className="flex flex-col gap-[14px]">
        ...
        <div className="flex flex-col gap-4">
          <span className="leading-150 pb-3 text-xl font-semibold text-white xl:text-2xl">
            Official info:
          </span>
          ...
          <div className="flex">
            <span className="leading-160 font-sans text-lg font-medium text-white xl:text-xl">
          ...
          <div>
            <form className="box-border">
              <input
                className="text-basicInterface3 mt-1 w-2/3 max-w-[223px] rounded-l-xl bg-white bg-opacity-20 p-[14px] text-lg font-normal leading-8 xl:w-full xl:p-[10px] 2xl:p-[14px]"
                placeholder="Email address"
              />
              <button
                type="submit"
                className="bg-primary -ml-1 inline-flex max-w-[128px] shrink-0 cursor-pointer overflow-hidden rounded-r-xl p-[14px] text-lg font-normal leading-8 text-white transition-all xl:p-[10px] 2xl:p-[14px]"
              >
                Subscribe
              </button>
            </form>
      ...
      <span className="leading-160 p-[22px] text-center text-sm font-medium text-white xl:text-xl">
