    ...
    <div className="store-wrapper">
      ...
      >
        <div className="relative w-full p-6">
                ...
                <div className="flex justify-center">
                  <a href="#">
                    <div className="bg-warning-300 hover:bg-warning-200 flex h-[56px] w-[166px] items-center justify-center rounded-lg transition duration-300 ease-in-out">
                      <span className="text-bgray-900 text-sm font-bold">Discover More</span>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div className="bonus-outer">
                <div className="bonus-inner">
                  <div className="number">
                    <span className="text-bgray-900 text-sm font-medium">25%</span>
                  </div>
                </div>
              </div>
          ...
          <p className="text-success-300 mb-2.5 text-center text-sm font-semibold">Discover more</p>
          <div className="flex justify-center">
            <Image
              priority={true}
