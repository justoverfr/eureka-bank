  ...
  return (
    <div className="message-popup-wrapper">
      ...
      <div
        ...
        className="dark:bg-darkblack-600 absolute -left-[276px] top-[81px] hidden w-[400px] rounded-lg bg-white"
      >
        <div className="relative w-full pb-[75px] pt-[66px]">
          ...
          <div>
            <div className="border-bgray-200 dark:border-darkblack-400 flex items-center border-b">
              <button
                aria-label="none"
                type="button"
                className="border-success-300 text-success-300 flex space-x-2 border-b-2 px-6 py-4 text-sm font-semibold capitalize"
              >
                <span>All</span>
                <span className="bg-success-50 text-success-300 inline-flex h-5 w-5 items-center justify-center rounded-full text-[10px]">
                  2
                </span>
              </button>
            </div>
            <ul className="scroll-style-1 h-[335px] w-full overflow-y-scroll">
              <li className="border-bgray-200 hover:bg-bgray-100 dark:border-darkblack-400 dark:hover:bg-darkblack-500 border-b px-7 py-6">
                <Link href="#">
                  <div className="flex space-x-3">
                    <div className="relative h-[48px] w-[48px] rounded-full">
                      ...
                      />
                      <div className="bg-bgray-300 absolute bottom-0 right-0 h-3 w-3 rounded-full border border-white"></div>
                    </div>
                    <div className="flex-1">
                      <p className="text-bgray-900 mb-1 text-base font-bold dark:text-white dark:text-white">
                        James Eusobio
                      </p>
                      <p className="text-bgray-500 dark:text-bgray-50 text-sm font-medium">
                  ...
                  <div className="flex space-x-3">
                    <div className="relative h-[48px] w-[48px] rounded-full">
                      <Image
                        ...
                        className="h-full w-full object-cover"
                      />
                      <div className="bg-success-300 absolute bottom-0 right-0 h-3 w-3 rounded-full border border-white"></div>
                    </div>
                    <div className="flex-1">
                      <p className="text-bgray-900 mb-1 text-base font-bold dark:text-white">
                        Eusobio Joy
                      </p>
