...
function HeaderOne({ handleSidebar }) {
  ...
  return (
    <header className="header-wrapper fixed z-30 hidden w-full md:block">
      <div className="dark:bg-darkblack-600 relative flex h-[108px] w-full items-center justify-between bg-white px-10 2xl:px-[76px]">
        <button
          aria-label="none"
        ...
        {/* page-title */}
        <div>
          <h3 className="text-bgray-900 dark:text-bgray-50 text-xl font-bold lg:text-3xl lg:leading-[36.4px]">
            Dashboard
          </h3>
          <p className="text-bgray-600 dark:text-bgray-50 text-xs font-medium lg:text-sm lg:leading-[25.2px]">
        ...
        <div className="quick-access-wrapper relative">
          <div className="flex items-center space-x-[43px]">
            ...
            <div className="bg-bgray-300 dark:bg-darkblack-400 hidden h-[48px] w-[1px] xl:block"></div>
            {/* author */}
