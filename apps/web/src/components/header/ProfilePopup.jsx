  ...
  return (
    <div className="profile-wrapper">
      ...
      <div
        ...
        className="profile-box dark:bg-darkblack-600 absolute right-0 top-[81px] hidden w-[300px] overflow-hidden rounded-lg bg-white"
      >
        <div className="relative w-full px-3 py-2">
          <div>
            <ul>
              <li className="w-full">
                <Link href="/settings">
                  <div className="text-bgray-600 hover:bg-bgray-100 hover:text-bgray-900 hover:dark:bg-darkblack-500 flex items-center space-x-[18px] rounded-lg p-[14px]">
              ...
              <li className="w-full">
                <Link href="/messages">
                  <div className="text-bgray-600 hover:bg-bgray-100 hover:text-bgray-900 dark:text-bgray-300 dark:hover:bg-darkblack-500 flex items-center space-x-[18px] rounded-lg p-[14px]">
                    <div className="w-[20px]">
                      <span>
                        <svg
              ...
              <li className="w-full">
                <Link href="#">
                  <div className="text-success-300 flex items-center space-x-[18px] rounded-lg p-[14px]">
                    <div className="w-[20px]">
                      <span>
                        <svg
                          width="24"
          ...
          <div>
            <ul>
              <li className="w-full">
                <Link href="/settings">
                  <div className="text-bgray-600 hover:bg-bgray-100 hover:text-bgray-900 dark:text-bgray-50 dark:hover:bg-darkblack-500 rounded-lg p-[14px]">
