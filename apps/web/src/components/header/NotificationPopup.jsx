  ...
  return (
    <div className="notification-popup-wrapper">
      ...
      <div
        ...
        className="dark:bg-darkblack-600 absolute -left-[347px] top-[81px] hidden w-[400px] rounded-lg bg-white"
      >
        <div className="relative w-full pb-[75px] pt-[66px]">
          ...
          <ul className="scroll-style-1 h-[335px] w-full overflow-y-scroll">
            <li className="border-bgray-200 hover:bg-bgray-100 dark:border-darkblack-400 dark:hover:bg-darkblack-500 border-b py-4 pl-6 pr-[50px]">
              <Link href="#">
