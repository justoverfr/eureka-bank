...
function SendMassage() {
  ...
  return (
    <div className="bottom-10 mb-5 w-full px-5 lg:absolute lg:mb-0 lg:px-11">
      <div>
        <Quill
          value={text.text}
          ...
          className="custom-quill-2 relative w-full"
        />
      </div>
      <div className="mt-4 flex justify-end">
        <button
          aria-label="none"
          name="button"
          className="bg-success-400 flex items-center justify-center gap-1.5 rounded-lg px-4 py-2.5 text-sm font-semibold text-white"
        >
          <svg
            width="20"
            height="20"
