    ...
    <div className="relative mb-5 h-full w-full">
      ...
      >
        <div className="flex w-full items-center justify-between">
          <span className="text-bgray-600 dark:text-bgray-50 text-base font-semibold">
            June 2022
          </span>
          <span>
            <svg
      ...
      <div
        ...
        className={`absolute right-0 top-5 z-10 w-full overflow-hidden rounded-lg bg-white shadow-lg ${
          active ? 'block' : 'hidden'
        } `}
      >
        <ul>
          ...
          <li
            onClick={() => setActive(!active)}
            className="text-bgray-900  hover:bg-bgray-100 cursor-pointer px-5 py-2 text-sm font-semibold"
          >
            February
          </li>
