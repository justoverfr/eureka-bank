...
function PersonalInfo({ name, activeTab }) {
  return (
    <div id="tab1" className={`tab-pane ${name === activeTab && 'active'}`}>
      <div className="flex grid-cols-12 flex-col-reverse gap-12 xl:grid 2xl:flex-row">
        <PersonalInfoFrom />
        <div className="xl:col-span-5 2xl:col-span-4 2xl:mt-24">
          <header className="mb-8">
            ...
            <div className="relative m-auto h-40 w-40 text-center">
              <Image
                ...
                alt=""
              />
              <button aria-label="none" className="absolute bottom-1 right-4">
                <svg
                  width="29"
                  height="29"
                  viewBox="0 0 29 29"
          ...
          <div>
            ...
            <div className="relative w-full">
              <Image
                ...
                alt=""
              />
              <button aria-label="none" className="absolute bottom-2 right-2">
                <svg
                  width="29"
                  height="29"
                  viewBox="0 0 29 29"
