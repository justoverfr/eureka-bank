...
function AddWallet() {
  ...
  return (
    <>
      ...
      <div
        className="modal-open border-bgray-500 flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed p-6"
      ...
      >
        ...
        <span className="text-bgray-600 text-lg font-medium">Add wallet</span>
      </div>
    </>
  );
}
