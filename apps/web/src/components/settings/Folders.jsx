function Folders() {
  return (
    <div className="flex h-24 w-24 flex-col items-center md:h-32 md:w-32 lg:h-44 lg:w-44">
      <svg
        width="120"
        height="120"
        viewBox="0 0 120 120"
      ...
      <h4 className="text-sm font-semibold md:text-xl dark:text-white">2021 Invoice</h4>
      <span className="text-bgray-600 dark:text-darkblack-300 text-xs md:text-base">120 MB</span>
    </div>
  );
}
